...
'wechat-medium': {
  ...
  // === Kami 出版级设计系统精选系列（8大经典出版物版式） ===

  // 1. Kami · 简历 (Founder Resume)
  'kami-resume': {
    name: 'Kami · 简历',
    styles: {
      container: 'max-width: 680px; margin: 0 auto; padding: 24px 20px 42px 20px; font-family: Charter, Georgia, "TsangerJinKai02", "Source Han Serif SC", "Noto Serif CJK SC", "Songti SC", "SimSun", serif; font-size: 15px; line-height: 1.65 !important; color: #141413 !important; background-color: #f5f4ed !important; word-wrap: break-word;',
      h1: 'font-family: Charter, Georgia, "TsangerJinKai02", "Source Han Serif SC", "Songti SC", serif; font-size: 26px; font-weight: 500; line-height: 1.2 !important; color: #141413 !important; margin: 28px 0 16px; padding-bottom: 8px; border-bottom: 1px solid #e8e6dc; letter-spacing: -0.2px;',
      h2: 'font-family: Charter, Georgia, "TsangerJinKai02", "Source Han Serif SC", "Songti SC", serif; font-size: 16px; font-weight: 600; line-height: 1.35 !important; color: #1B365D !important; margin: 24px 0 12px; padding-bottom: 4px; border-bottom: 0.5px solid #e8e6dc; letter-spacing: 0.5px;',
      h3: 'font-family: Charter, Georgia, "TsangerJinKai02", "Source Han Serif SC", "Songti SC", serif; font-size: 15px; font-weight: 600; line-height: 1.4 !important; color: #141413 !important; margin: 18px 0 8px;',
      h4: 'font-family: Charter, Georgia, "TsangerJinKai02", "Source Han Serif SC", "Songti SC", serif; font-size: 14px; font-weight: 600; color: #504e49 !important; line-height: 1.4 !important; margin: 14px 0 6px;',
      h5: 'font-family: Charter, Georgia, "TsangerJinKai02", "Source Han Serif SC", "Songti SC", serif; font-size: 13.5px; font-weight: 600; color: #504e49 !important; line-height: 1.4 !important; margin: 12px 0 6px;',
      h6: 'font-family: Charter, Georgia, "TsangerJinKai02", "Source Han Serif SC", "Songti SC", serif; font-size: 13px; font-weight: 600; color: #6b6a64 !important; line-height: 1.4 !important; margin: 10px 0 5px;',
      p: 'margin: 12px 0 !important; line-height: 1.65 !important; color: #141413 !important; letter-spacing: 0.2px;',
      strong: 'font-weight: 600; color: #141413 !important;',
      em: 'font-style: normal; color: #504e49 !important; font-weight: 500;',
      a: 'color: #1B365D !important; text-decoration: none; border-bottom: 1px solid #1B365D; font-weight: 500;',
      ul: 'margin: 14px 0; padding-left: 22px; list-style-type: disc;',
      ol: 'margin: 14px 0; padding-left: 22px; list-style-type: decimal;',
      li: 'margin: 6px 0; line-height: 1.6 !important; color: #141413 !important;',
      blockquote: 'margin: 18px 0; padding: 12px 18px; background-color: #faf9f5 !important; border-left: 3px solid #1B365D; border-radius: 0 4px 4px 0; color: #3d3d3a !important; font-size: 14px; line-height: 1.6 !important;',
      code: 'font-family: "JetBrains Mono", "SF Mono", Consolas, monospace; font-size: 13.5px; padding: 2px 6px; background-color: #f0eee6 !important; color: #1B365D !important; border-radius: 3px; font-weight: 500;',
      pre: 'margin: 20px 0; padding: 16px; background-color: #faf9f5 !important; border: 1px solid #e8e6dc; border-radius: 4px; overflow-x: auto; line-height: 1.5 !important; font-size: 13.5px;',
      hr: 'margin: 28px 0; border: none; height: 1px; background-color: #e8e6dc !important;',
      img: 'max-width: 100%; max-height: 600px !important; height: auto; display: block; margin: 20px auto; border-radius: 4px; border: 1px solid #e8e6dc;',
      table: 'width: 100%; margin: 18px 0; border-collapse: collapse; font-size: 13.5px;',
      th: 'background-color: #faf9f5 !important; color: #1B365D !important; padding: 8px 12px; text-align: left; font-weight: 600; border-bottom: 1.5px solid #1B365D;',
      td: 'padding: 8px 12px; border-bottom: 1px solid #e8e6dc; color: #141413 !important;',
      tr: 'border-bottom: 1px solid #e8e6dc;',
    }
  },

  // 2. Kami · 白底单页 (Kami Print One-Pager)
  'kami-print': {
    name: 'Kami · 白底单页',
    styles: {
      container: 'max-width: 680px; margin: 0 auto; padding: 24px 20px 42px 20px; font-family: "TsangerJinKai02", "Source Han Serif SC", "Noto Serif CJK SC", "Songti SC", "STSong", "SimSun", Georgia, serif; font-size: 15.5px; line-height: 1.75 !important; color: #141413 !important; background-color: #ffffff !important; word-wrap: break-word; letter-spacing: 0.3pt;',
      h1: 'font-family: "TsangerJinKai02", "Source Han Serif SC", "Songti SC", Georgia, serif; font-size: 26px; font-weight: 500; line-height: 1.2 !important; color: #141413 !important; margin: 32px 0 16px; padding-bottom: 10px; border-bottom: 1px solid #e8e6dc;',
      h2: 'font-family: "TsangerJinKai02", "Source Han Serif SC", "Songti SC", Georgia, serif; font-size: 19px; font-weight: 500; line-height: 1.35 !important; color: #1B365D !important; margin: 26px 0 12px; padding-left: 10px; border-left: 3px solid #1B365D;',
      h3: 'font-family: "TsangerJinKai02", "Source Han Serif SC", "Songti SC", Georgia, serif; font-size: 16px; font-weight: 500; line-height: 1.4 !important; color: #3d3d3a !important; margin: 20px 0 10px;',
      h4: 'font-family: "TsangerJinKai02", "Source Han Serif SC", "Songti SC", Georgia, serif; font-size: 15px; font-weight: 500; color: #504e49 !important; line-height: 1.4 !important; margin: 16px 0 8px;',
      h5: 'font-family: "TsangerJinKai02", "Source Han Serif SC", "Songti SC", Georgia, serif; font-size: 14px; font-weight: 500; color: #504e49 !important; line-height: 1.4 !important; margin: 14px 0 7px;',
      h6: 'font-family: "TsangerJinKai02", "Source Han Serif SC", "Songti SC", Georgia, serif; font-size: 13.5px; font-weight: 500; color: #6b6a64 !important; line-height: 1.4 !important; margin: 12px 0 6px;',
      p: 'margin: 14px 0 !important; line-height: 1.75 !important; color: #141413 !important; text-align: justify;',
      strong: 'font-weight: 600; color: #1B365D !important;',
      em: 'font-style: normal; color: #504e49 !important; font-weight: 500;',
      ...
      li: 'margin: 7px 0; line-height: 1.7 !important; color: #141413 !important;',
      blockquote: 'margin: 20px 0; padding: 12px 18px; background-color: #E4ECF5 !important; border-left: 3px solid #1B365D; border-radius: 0 4px 4px 0; color: #1B365D !important; font-size: 14.5px; line-height: 1.65 !important;',
      code: 'font-family: "JetBrains Mono", "SF Mono", Consolas, monospace; font-size: 14px; padding: 2px 6px; background-color: #EEF2F7 !important; color: #1B365D !important; border-radius: 3px; font-weight: 500;',
      pre: 'margin: 22px 0; padding: 16px; background-color: #faf9f5 !important; border: 1px solid #e8e6dc; border-radius: 4px; overflow-x: auto; line-height: 1.55 !important; font-size: 13.5px;',
      hr: 'margin: 32px 0; border: none; height: 1px; background-color: #e8e6dc !important;',
      img: 'max-width: 100%; max-height: 600px !important; height: auto; display: block; margin: 22px auto; border-radius: 4px; border: 1px solid #e8e6dc;',
      table: 'width: 100%; margin: 20px 0; border-collapse: collapse; font-size: 14px;',
      th: 'background-color: #f7f6f2 !important; color: #1B365D !important; padding: 9px 12px; text-align: left; font-weight: 600; border-bottom: 1.5px solid #1B365D;',
      td: 'padding: 9px 12px; border-bottom: 1px solid #e8e6dc; color: #141413 !important;',
      tr: 'border-bottom: 1px solid #e8e6dc;',
    }
  },

  // 3. Kami · 财报研报 (Equity Report)
  'kami-report': {
    name: 'Kami · 财报研报',
    styles: {
      container: 'max-width: 680px; margin: 0 auto; padding: 24px 20px 42px 20px; font-family: "TsangerJinKai02", "Source Han Serif SC", "Noto Serif CJK SC", "Songti SC", Georgia, serif; font-size: 15px; line-height: 1.7 !important; color: #141413 !important; background-color: #f5f4ed !important; word-wrap: break-word; letter-spacing: 0.3pt;',
      h1: 'font-family: "TsangerJinKai02", "Source Han Serif SC", "Songti SC", Georgia, serif; font-size: 25px; font-weight: 500; line-height: 1.2 !important; color: #141413 !important; margin: 30px 0 16px; padding-bottom: 8px; border-bottom: 1.5px solid #1B365D;',
      h2: 'font-family: "TsangerJinKai02", "Source Han Serif SC", "Songti SC", Georgia, serif; font-size: 17px; font-weight: 500; line-height: 1.35 !important; color: #1B365D !important; margin: 26px 0 12px; padding: 4px 0 4px 8px; border-left: 3px solid #1B365D; border-bottom: 0.5px solid #e8e6dc;',
      h3: 'font-family: "TsangerJinKai02", "Source Han Serif SC", "Songti SC", Georgia, serif; font-size: 15px; font-weight: 600; line-height: 1.4 !important; color: #3d3d3a !important; margin: 20px 0 10px;',
      h4: 'font-family: "TsangerJinKai02", "Source Han Serif SC", "Songti SC", Georgia, serif; font-size: 14px; font-weight: 600; color: #504e49 !important; line-height: 1.4 !important; margin: 16px 0 8px;',
      h5: 'font-family: "TsangerJinKai02", "Source Han Serif SC", "Songti SC", Georgia, serif; font-size: 13.5px; font-weight: 600; color: #504e49 !important; line-height: 1.4 !important; margin: 14px 0 6px;',
      h6: 'font-family: "TsangerJinKai02", "Source Han Serif SC", "Songti SC", Georgia, serif; font-size: 13px; font-weight: 600; color: #6b6a64 !important; line-height: 1.4 !important; margin: 12px 0 6px;',
      p: 'margin: 13px 0 !important; line-height: 1.7 !important; color: #141413 !important; text-align: justify;',
      strong: 'font-weight: 600; color: #1B365D !important;',
      em: 'font-style: normal; color: #504e49 !important;',
      a: 'color: #1B365D !important; text-decoration: none; border-bottom: 1px solid #1B365D; font-weight: 500;',
      ul: 'margin: 14px 0; padding-left: 22px; list-style-type: disc;',
      ol: 'margin: 14px 0; padding-left: 22px; list-style-type: decimal;',
      li: 'margin: 6px 0; line-height: 1.65 !important; color: #141413 !important;',
      blockquote: 'margin: 18px 0; padding: 12px 16px; background-color: #faf9f5 !important; border: 1px solid #e8e6dc; border-left: 3.5px solid #1B365D; border-radius: 3px; color: #3d3d3a !important; font-size: 14px; line-height: 1.65 !important;',
      code: 'font-family: "JetBrains Mono", "SF Mono", Consolas, monospace; font-size: 13.5px; padding: 2px 5px; background-color: #f0eee6 !important; color: #141413 !important; border: 1px solid #e5e3d8; border-radius: 2px;',
      pre: 'margin: 20px 0; padding: 16px; background-color: #faf9f5 !important; border: 1px solid #e8e6dc; border-radius: 4px; overflow-x: auto; line-height: 1.5 !important;',
      hr: 'margin: 30px 0; border: none; height: 1px; background-color: #e8e6dc !important;',
      img: 'max-width: 100%; max-height: 600px !important; height: auto; display: block; margin: 20px auto; border-radius: 3px; border: 1px solid #e8e6dc;',
      table: 'width: 100%; margin: 20px 0; border-collapse: collapse; font-size: 13.5px; border-top: 2px solid #1B365D; border-bottom: 1.5px solid #1B365D;',
      th: 'background-color: #faf9f5 !important; color: #1B365D !important; padding: 9px 10px; text-align: left; font-weight: 600; border-bottom: 1px solid #1B365D;',
      td: 'padding: 8px 10px; border-bottom: 1px solid #e8e6dc; color: #141413 !important;',
      tr: 'border-bottom: 1px solid #e8e6dc;',
    }
  },

  // 4. Kami · 演讲文稿 (Keynote Slides)
  'kami-slides': {
    name: 'Kami · 演讲文稿',
    styles: {
      container: 'max-width: 680px; margin: 0 auto; padding: 28px 22px 48px 22px; font-family: Charter, Georgia, "TsangerJinKai02", "Source Han Serif SC", "Songti SC", serif; font-size: 16px; line-height: 1.85 !important; color: #141413 !important; background-color: #f5f4ed !important; word-wrap: break-word;',
      h1: 'font-family: Charter, Georgia, "TsangerJinKai02", "Source Han Serif SC", "Songti SC", serif; font-size: 28px; font-weight: 500; line-height: 1.15 !important; color: #141413 !important; margin: 36px 0 20px; letter-spacing: -0.5px; text-align: center;',
      h2: 'font-family: Charter, Georgia, "TsangerJinKai02", "Source Han Serif SC", "Songti SC", serif; font-size: 21px; font-weight: 500; line-height: 1.3 !important; color: #141413 !important; margin: 30px 0 14px; padding-bottom: 6px; border-bottom: 1px solid #e8e6dc;',
      h3: 'font-family: Charter, Georgia, "TsangerJinKai02", "Source Han Serif SC", "Songti SC", serif; font-size: 17px; font-weight: 500; line-height: 1.35 !important; color: #1B365D !important; margin: 22px 0 10px;',
      h4: 'font-family: Charter, Georgia, "TsangerJinKai02", "Source Han Serif SC", "Songti SC", serif; font-size: 15.5px; font-weight: 600; color: #504e49 !important; line-height: 1.4 !important; margin: 18px 0 8px;',
      h5: 'font-family: Charter, Georgia, "TsangerJinKai02", "Source Han Serif SC", "Songti SC", serif; font-size: 14.5px; font-weight: 600; color: #504e49 !important; line-height: 1.4 !important; margin: 16px 0 8px;',
      h6: 'font-family: Charter, Georgia, "TsangerJinKai02", "Source Han Serif SC", "Songti SC", serif; font-size: 14px; font-weight: 600; color: #6b6a64 !important; line-height: 1.4 !important; margin: 14px 0 6px;',
      p: 'margin: 16px 0 !important; line-height: 1.85 !important; color: #141413 !important;',
      strong: 'font-weight: 600; color: #1B365D !important;',
      em: 'font-style: normal; color: #504e49 !important; font-weight: 500;',
      a: 'color: #1B365D !important; text-decoration: none; border-bottom: 1px solid #1B365D;',
      ul: 'margin: 18px 0; padding-left: 24px; list-style-type: disc;',
      ol: 'margin: 18px 0; padding-left: 24px; list-style-type: decimal;',
      li: 'margin: 10px 0; line-height: 1.75 !important; color: #141413 !important;',
      blockquote: 'margin: 24px 0; padding: 18px 22px; background-color: #faf9f5 !important; border: 1px solid #e8e6dc; border-radius: 6px; color: #3d3d3a !important; font-size: 16.5px; line-height: 1.75 !important; text-align: center; font-style: normal;',
      code: 'font-family: "JetBrains Mono", "SF Mono", Consolas, monospace; font-size: 14px; padding: 3px 6px; background-color: #f0eee6 !important; color: #1B365D !important; border-radius: 3px;',
      pre: 'margin: 24px 0; padding: 18px; background-color: #faf9f5 !important; border: 1px solid #e8e6dc; border-radius: 6px; overflow-x: auto; line-height: 1.55 !important;',
      hr: 'margin: 36px 0; border: none; height: 1px; background-color: #e8e6dc !important;',
      img: 'max-width: 100%; max-height: 600px !important; height: auto; display: block; margin: 24px auto; border-radius: 6px; border: 1px solid #e8e6dc;',
      table: 'width: 100%; margin: 22px 0; border-collapse: collapse; font-size: 14.5px;',
      th: 'background-color: #faf9f5 !important; color: #141413 !important; padding: 10px 14px; text-align: left; font-weight: 600; border-bottom: 1.5px solid #141413;',
      td: 'padding: 10px 14px; border-bottom: 1px solid #e8e6dc; color: #3d3d3a !important;',
      tr: 'border-bottom: 1px solid #e8e6dc;',
    }
  },

  // 5. Kami · 产品简报 (Product Brief)
  'kami-product': {
    name: 'Kami · 产品简报',
    styles: {
      container: 'max-width: 680px; margin: 0 auto; padding: 24px 20px 42px 20px; font-family: Charter, Georgia, "TsangerJinKai02", "Source Han Serif SC", "Songti SC", serif; font-size: 15px; line-height: 1.7 !important; color: #141413 !important; background-color: #f5f4ed !important; word-wrap: break-word;',
      h1: 'font-family: Charter, Georgia, "TsangerJinKai02", "Source Han Serif SC", "Songti SC", serif; font-size: 26px; font-weight: 500; line-height: 1.15 !important; color: #141413 !important; margin: 30px 0 16px; padding-bottom: 8px; border-bottom: 0.5px solid #e8e6dc; letter-spacing: -0.3px;',
      h2: 'font-family: Charter, Georgia, "TsangerJinKai02", "Source Han Serif SC", "Songti SC", serif; font-size: 18px; font-weight: 500; line-height: 1.35 !important; color: #1B365D !important; margin: 26px 0 12px;',
      h3: 'font-family: Charter, Georgia, "TsangerJinKai02", "Source Han Serif SC", "Songti SC", serif; font-size: 15.5px; font-weight: 600; line-height: 1.4 !important; color: #3d3d3a !important; margin: 20px 0 10px;',
      h4: 'font-family: Charter, Georgia, "TsangerJinKai02", "Source Han Serif SC", "Songti SC", serif; font-size: 14.5px; font-weight: 600; color: #504e49 !important; line-height: 1.4 !important; margin: 16px 0 8px;',
      h5: 'font-family: Charter, Georgia, "TsangerJinKai02", "Source Han Serif SC", "Songti SC", serif; font-size: 14px; font-weight: 600; color: #504e49 !important; line-height: 1.4 !important; margin: 14px 0 6px;',
      h6: 'font-family: Charter, Georgia, "TsangerJinKai02", "Source Han Serif SC", "Songti SC", serif; font-size: 13.5px; font-weight: 600; color: #6b6a64 !important; line-height: 1.4 !important; margin: 12px 0 6px;',
      p: 'margin: 14px 0 !important; line-height: 1.7 !important; color: #141413 !important;',
      strong: 'font-weight: 600; color: #1B365D !important;',
      em: 'font-style: normal; color: #504e49 !important;',
      a: 'color: #1B365D !important; text-decoration: none; border-bottom: 1px solid #1B365D; font-weight: 500;',
      ul: 'margin: 16px 0; padding-left: 22px; list-style-type: disc;',
      ol: 'margin: 16px 0; padding-left: 22px; list-style-type: decimal;',
      li: 'margin: 7px 0; line-height: 1.65 !important; color: #141413 !important;',
      blockquote: 'margin: 20px 0; padding: 14px 18px; background-color: #faf9f5 !important; border: 1px solid #e8e6dc; border-left: 3px solid #1B365D; border-radius: 4px; color: #3d3d3a !important; font-size: 14.5px; line-height: 1.65 !important;',
      code: 'font-family: "JetBrains Mono", "SF Mono", Consolas, monospace; font-size: 13.5px; padding: 2px 6px; background-color: #EEF2F7 !important; color: #1B365D !important; border-radius: 3px; font-weight: 500;',
      pre: 'margin: 22px 0; padding: 16px; background-color: #faf9f5 !important; border: 1px solid #e8e6dc; border-radius: 5px; overflow-x: auto; line-height: 1.55 !important;',
      hr: 'margin: 32px 0; border: none; height: 1px; background-color: #e8e6dc !important;',
      img: 'max-width: 100%; max-height: 600px !important; height: auto; display: block; margin: 22px auto; border-radius: 6px; border: 1px solid #e8e6dc; box-shadow: 0 4px 12px rgba(20, 20, 19, 0.05);',
      table: 'width: 100%; margin: 20px 0; border-collapse: collapse; font-size: 14px;',
      th: 'background-color: #faf9f5 !important; color: #1B365D !important; padding: 9px 12px; text-align: left; font-weight: 600; border-bottom: 1.5px solid #1B365D;',
      td: 'padding: 9px 12px; border-bottom: 1px solid #e8e6dc; color: #141413 !important;',
      tr: 'border-bottom: 1px solid #e8e6dc;',
    }
  },
  ...
  'kami-letter': {
    name: 'Kami · 正式信函',
    styles: {
      container: 'max-width: 680px; margin: 0 auto; padding: 28px 22px 46px 22px; font-family: "TsangerJinKai02", "Source Han Serif SC", "Noto Serif CJK SC", "Songti SC", "STSong", "SimSun", Georgia, serif; font-size: 15.5px; line-height: 1.85 !important; color: #141413 !important; background-color: #f5f4ed !important; word-wrap: break-word; letter-spacing: 0.3pt;',
      h1: 'font-family: "TsangerJinKai02", "Source Han Serif SC", "Songti SC", Georgia, serif; font-size: 24px; font-weight: 500; line-height: 1.3 !important; color: #141413 !important; margin: 32px 0 20px; text-align: center; letter-spacing: 1px;',
      h2: 'font-family: "TsangerJinKai02", "Source Han Serif SC", "Songti SC", Georgia, serif; font-size: 18px; font-weight: 500; line-height: 1.4 !important; color: #3d3d3a !important; margin: 26px 0 14px; text-align: left;',
      h3: 'font-family: "TsangerJinKai02", "Source Han Serif SC", "Songti SC", Georgia, serif; font-size: 16px; font-weight: 500; line-height: 1.4 !important; color: #1B365D !important; margin: 20px 0 10px;',
      h4: 'font-family: "TsangerJinKai02", "Source Han Serif SC", "Songti SC", Georgia, serif; font-size: 15px; font-weight: 500; color: #504e49 !important; line-height: 1.4 !important; margin: 16px 0 8px;',
      h5: 'font-family: "TsangerJinKai02", "Source Han Serif SC", "Songti SC", Georgia, serif; font-size: 14px; font-weight: 500; color: #504e49 !important; line-height: 1.4 !important; margin: 14px 0 7px;',
      h6: 'font-family: "TsangerJinKai02", "Source Han Serif SC", "Songti SC", Georgia, serif; font-size: 13.5px; font-weight: 500; color: #6b6a64 !important; line-height: 1.4 !important; margin: 12px 0 6px;',
      p: 'margin: 16px 0 !important; line-height: 1.85 !important; color: #141413 !important; text-indent: 2em; text-align: justify;',
      strong: 'font-weight: 600; color: #141413 !important;',
      em: 'font-style: normal; color: #504e49 !important;',
      a: 'color: #1B365D !important; text-decoration: none; border-bottom: 1px solid #1B365D;',
      ul: 'margin: 16px 0; padding-left: 28px; list-style-type: disc;',
      ol: 'margin: 16px 0; padding-left: 28px; list-style-type: decimal;',
      li: 'margin: 8px 0; line-height: 1.75 !important; color: #141413 !important;',
      blockquote: 'margin: 22px 2em; padding: 12px 18px; background-color: #faf9f5 !important; border-left: 2px solid #6b6a64; color: #504e49 !important; font-size: 14.5px; line-height: 1.75 !important;',
      code: 'font-family: "JetBrains Mono", Consolas, monospace; font-size: 13.5px; padding: 2px 5px; background-color: #f0eee6 !important; color: #1B365D !important; border-radius: 2px;',
      pre: 'margin: 20px 0; padding: 15px; background-color: #faf9f5 !important; border: 1px solid #e8e6dc; border-radius: 3px; font-size: 13.5px;',
      hr: 'margin: 32px auto; border: none; height: 1px; background-color: #dcd8cb !important; width: 60%;',
      img: 'max-width: 100%; max-height: 600px !important; height: auto; display: block; margin: 24px auto; border-radius: 2px; border: 1px solid #dcd8cb;',
      table: 'width: 100%; margin: 20px 0; border-collapse: collapse; font-size: 14px;',
      th: 'background-color: #faf9f5 !important; color: #141413 !important; padding: 8px 12px; text-align: left; font-weight: 500; border-bottom: 1px solid #6b6a64;',
      td: 'padding: 8px 12px; border-bottom: 1px solid #e8e6dc; color: #3d3d3a !important;',
      tr: 'border-bottom: 1px solid #e8e6dc;',
    }
  },

  // 7. Kami · 更新日志 (Changelog)
  'kami-changelog': {
    name: 'Kami · 更新日志',
    styles: {
      container: 'max-width: 680px; margin: 0 auto; padding: 24px 20px 42px 20px; font-family: Charter, Georgia, "TsangerJinKai02", "Source Han Serif SC", "Songti SC", serif; font-size: 15px; line-height: 1.7 !important; color: #141413 !important; background-color: #f5f4ed !important; word-wrap: break-word;',
      h1: 'font-family: Charter, Georgia, "TsangerJinKai02", "Source Han Serif SC", "Songti SC", serif; font-size: 26px; font-weight: 500; line-height: 1.15 !important; color: #141413 !important; margin: 28px 0 16px; padding-bottom: 8px; border-bottom: 0.5px solid #e8e6dc; letter-spacing: -0.4px;',
      h2: 'font-family: Charter, Georgia, "TsangerJinKai02", "Source Han Serif SC", "Songti SC", serif; font-size: 17px; font-weight: 600; line-height: 1.35 !important; color: #141413 !important; margin: 24px 0 12px; padding-left: 8px; border-left: 3px solid #1B365D;',
      h3: 'font-family: Charter, Georgia, "TsangerJinKai02", "Source Han Serif SC", "Songti SC", serif; font-size: 15px; font-weight: 600; line-height: 1.4 !important; color: #504e49 !important; margin: 18px 0 8px;',
      h4: 'font-family: Charter, Georgia, "TsangerJinKai02", "Source Han Serif SC", "Songti SC", serif; font-size: 14px; font-weight: 600; color: #6b6a64 !important; line-height: 1.4 !important; margin: 14px 0 6px;',
      h5: 'font-family: Charter, Georgia, "TsangerJinKai02", "Source Han Serif SC", "Songti SC", serif; font-size: 13.5px; font-weight: 600; color: #6b6a64 !important; line-height: 1.4 !important; margin: 12px 0 6px;',
      h6: 'font-family: Charter, Georgia, "TsangerJinKai02", "Source Han Serif SC", "Songti SC", serif; font-size: 13px; font-weight: 600; color: #6b6a64 !important; line-height: 1.4 !important; margin: 10px 0 5px;',
      p: 'margin: 12px 0 !important; line-height: 1.7 !important; color: #141413 !important;',
      strong: 'font-weight: 600; color: #1B365D !important;',
      em: 'font-style: normal; color: #504e49 !important;',
      a: 'color: #1B365D !important; text-decoration: none; border-bottom: 1px solid #1B365D; font-weight: 500;',
      ul: 'margin: 14px 0; padding-left: 20px; list-style-type: square;',
      ol: 'margin: 14px 0; padding-left: 20px; list-style-type: decimal;',
      li: 'margin: 6px 0; line-height: 1.65 !important; color: #141413 !important;',
      blockquote: 'margin: 18px 0; padding: 12px 16px; background-color: #f0e0d8 !important; border-left: 3px solid #8b4513; border-radius: 0 4px 4px 0; color: #8b4513 !important; font-size: 14px; line-height: 1.6 !important; font-weight: 500;',
      code: 'font-family: "JetBrains Mono", "SF Mono", Consolas, monospace; font-size: 13.5px; padding: 2px 6px; background-color: #E4ECF5 !important; color: #1B365D !important; border-radius: 3px; font-weight: 500;',
      pre: 'margin: 20px 0; padding: 15px; background-color: #faf9f5 !important; border: 1px solid #e8e6dc; border-radius: 4px; overflow-x: auto; line-height: 1.5 !important; font-size: 13.5px;',
      hr: 'margin: 28px 0; border: none; height: 1px; background-color: #e8e6dc !important;',
      img: 'max-width: 100%; max-height: 600px !important; height: auto; display: block; margin: 20px auto; border-radius: 4px; border: 1px solid #e8e6dc;',
      table: 'width: 100%; margin: 18px 0; border-collapse: collapse; font-size: 13.5px;',
      th: 'background-color: #faf9f5 !important; color: #141413 !important; padding: 8px 12px; text-align: left; font-weight: 600; border-bottom: 1px solid #1B365D;',
      td: 'padding: 8px 12px; border-bottom: 1px solid #e8e6dc; color: #141413 !important;',
      tr: 'border-bottom: 1px solid #e8e6dc;',
    }
  },

  // 8. Kami · 沉静画册 (Portfolio)
  'kami-portfolio': {
    name: 'Kami · 沉静画册',
    styles: {
      container: 'max-width: 680px; margin: 0 auto; padding: 30px 22px 50px 22px; font-family: "Hiragino Mincho ProN", "YuMincho", "Yu Mincho", "Source Han Serif SC", "Noto Serif CJK JP", "Songti SC", Georgia, serif; font-size: 15px; line-height: 1.85 !important; color: #141413 !important; background-color: #f5f4ed !important; word-wrap: break-word; letter-spacing: 0.5pt;',
      h1: 'font-family: "Hiragino Mincho ProN", "YuMincho", "Source Han Serif SC", "Songti SC", Georgia, serif; font-size: 28px; font-weight: 500; line-height: 1.2 !important; color: #141413 !important; margin: 36px 0 22px; letter-spacing: 1px; padding-bottom: 8px; border-bottom: 0.5px solid #e5e3d8;',
      h2: 'font-family: "Hiragino Mincho ProN", "YuMincho", "Source Han Serif SC", "Songti SC", Georgia, serif; font-size: 19px; font-weight: 500; line-height: 1.35 !important; color: #4d4c48 !important; margin: 28px 0 14px; letter-spacing: 0.8px;',
      h3: 'font-family: "Hiragino Mincho ProN", "YuMincho", "Source Han Serif SC", "Songti SC", Georgia, serif; font-size: 16px; font-weight: 500; line-height: 1.4 !important; color: #504e49 !important; margin: 20px 0 10px;',
      h4: 'font-family: "Hiragino Mincho ProN", "YuMincho", "Source Han Serif SC", "Songti SC", Georgia, serif; font-size: 15px; font-weight: 500; color: #6b6a64 !important; line-height: 1.4 !important; margin: 16px 0 8px;',
      h5: 'font-family: "Hiragino Mincho ProN", "YuMincho", "Source Han Serif SC", "Songti SC", Georgia, serif; font-size: 14px; font-weight: 500; color: #6b6a64 !important; line-height: 1.4 !important; margin: 14px 0 6px;',
      h6: 'font-family: "Hiragino Mincho ProN", "YuMincho", "Source Han Serif SC", "Songti SC", Georgia, serif; font-size: 13.5px; font-weight: 500; color: #6b6a64 !important; line-height: 1.4 !important; margin: 12px 0 6px;',
      p: 'margin: 16px 0 !important; line-height: 1.85 !important; color: #3d3d3a !important; text-align: justify;',
      strong: 'font-weight: 600; color: #141413 !important;',
      em: 'font-style: normal; color: #504e49 !important;',
      a: 'color: #1B365D !important; text-decoration: none; border-bottom: 1px solid #1B365D;',
      ul: 'margin: 16px 0; padding-left: 24px; list-style-type: disc;',
      ol: 'margin: 16px 0; padding-left: 24px; list-style-type: decimal;',
      li: 'margin: 8px 0; line-height: 1.8 !important; color: #3d3d3a !important;',
      blockquote: 'margin: 22px 0; padding: 14px 20px; background-color: #faf9f5 !important; border-left: 2px solid #6b6a64; color: #504e49 !important; font-size: 14.5px; line-height: 1.8 !important; letter-spacing: 0.5px;',
      code: 'font-family: "JetBrains Mono", Consolas, monospace; font-size: 13.5px; padding: 2px 6px; background-color: #E4ECF5 !important; color: #1B365D !important; border-radius: 2px;',
      pre: 'margin: 24px 0; padding: 18px; background-color: #faf9f5 !important; border: 1px solid #e5e3d8; border-radius: 2px; overflow-x: auto; line-height: 1.6 !important;',
      hr: 'margin: 36px 0; border: none; height: 1px; background-color: #e5e3d8 !important;',
      img: 'max-width: 100%; max-height: 600px !important; height: auto; display: block; margin: 26px auto; border-radius: 2px; border: 1px solid #e5e3d8;',
      table: 'width: 100%; margin: 22px 0; border-collapse: collapse; font-size: 14px;',
      th: 'background-color: #faf9f5 !important; color: #4d4c48 !important; padding: 9px 12px; text-align: left; font-weight: 500; border-bottom: 1px solid #4d4c48;',
      td: 'padding: 9px 12px; border-bottom: 1px solid #e5e3d8; color: #3d3d3a !important;',
